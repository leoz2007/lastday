...
- **Pipeline HDR** : multisampling confiné à la passe géométrie (render target MSAA ×4), **bloom à résolution réduite** pour la lueur large à moindre coût, tone mapping ACES, **grain de film + micro-saturation** en post ; lumières dynamiques ; crépuscule embrasé pendant la transition jour/nuit ; grading doré harmonisé (ciel crème, soleil chaud, brouillard chaud).
- **Océan simulé** : la bathymétrie procédurale de l'île est portée telle quelle en GLSL, si bien que l'eau connaît la **vraie profondeur** en chaque point — trains de **Gerstner** (déplacement horizontal + vertical) dont l'amplitude est **écrêtée par la profondeur** (les vagues cassent au rivage et se cambrent dans les hauts-fonds), **absorption de Beer-Lambert** turquoise → abysse, **écume en champ cellulaire de Worley** tuilé (le bord de swash s'effiloche au lieu de s'estomper), chemin de soleil scintillant, transparence sur le sable.
- **Bioluminescence nocturne** : la nuit, l'eau ne s'illumine que là où elle est agitée — déferlement, cisaillement, bord de swash — en plaques éparses pulsantes portées par le bloom.
- **Vie marine** : un **banc de 110 poissons en un seul draw call instancié** (allure individuelle bornée, respiration de formation, compression et fuite à l'approche du joueur ou de la baleine) ; une **baleine à bosse** fait surface au large pour souffler, et tente parfois un **breach balistique** — jaillissement, roulis à l'apex, retombée sur le flanc, couronne primaire, claque du corps retardée, gouttelettes et brume, le tout partageant les mêmes points de contact qui sèment des **anneaux de surface persistants**.
